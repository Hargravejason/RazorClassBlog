...
builder.Services.AddBlogging<CosmosBlogDbContext>(options =>
{
  ...
  options.RecentPostsCount = 4;                         // default number of posts in the reusable widget
  options.RecentPostsLayout = "horizontal";            // default layout in widget: "vertical" or "horizontal"
